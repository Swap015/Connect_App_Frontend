...
const MessageBubble = ({ message, isOwn, onDelete }) => {
    ...
    return (
        <div className={`flex ${isOwn ? "justify-end" : "justify-start"} mb-2 relative`}>
            <div
                className={`max-w-xs text-sm px-4 py-2 rounded-lg shadow-md relative ${isOwn
            ...
            >
                ...
                {isOwn && (
                    <div className="absolute top-1 right-1">
                        ...
                        {menuOpen && (
                            <div className="absolute right-0 mt-2 w-32 bg-white text-black rounded shadow-md text-xs">
                                <button
                                    onClick={() => {
                                        onDelete(false);
                                        setMenuOpen(false);
                                    }}
                                    className="block w-full px-3 py-2 hover:bg-gray-300"
                                >
                                    Delete for me
                                </button>
                                <button
